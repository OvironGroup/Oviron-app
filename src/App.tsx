							...
							<div className="mt-5 grid md:grid-cols-2 gap-10 sm:grid-cols-1">
								<div className="text-center p-3 bg-gray_800 shadow-lg shadow-gray_800">
									<h4 className="text-4xl flex justify-center leading-normal">
										<Ovnet
											className={`mr-4 ${styles.Ovnet} ${styles.ToolsIcon}`}
										/>{' '}
										<span>Ovnet</span>
									</h4>
									<p className="my-5 text-xl leading-9">
										Build your spaces, showcase your work, meet with others, and
										get inspired. Ovnet, enhancing networking for digital
								...
								<div className="text-center p-3 bg-gray_800 shadow-lg shadow-gray_800">
									...
									<p className="my-5 text-xl leading-9">
										Paint, Create models, Design worlds, and compose animated
										scenes with OStudio, a compositing & 3D modeling web
										application.
									</p>
									<a
								...
								<div className="text-center p-3 bg-gray_800 shadow-lg shadow-gray_800">
									...
									<p className="my-5 text-xl leading-9">
										Discover and download affordable 3D assets or Register and
										sell your creations with Orchives, the library for 3D
										modelers, game devs, and more.
									</p>
									<a
								...
								<div className="text-center p-3 bg-gray_800 shadow-lg shadow-gray_800">
									...
									<p className="my-5 text-xl leading-9">
										The online academy to enroll into 3D modeling, game
										development, and VR related courses, or publishing your
								...
								<div className="text-center p-3 bg-gray_800 shadow-lg shadow-gray_800">
									...
									<p className="my-5 text-xl leading-9">
										Combine the power of OVIRON tools into this gamified
										experience built for VR from the ground up. Oviron Space,
										the sandbox open verse where imagination is the limit.
										Create anything, own everything!
									</p>
									<a
						...
						<div className="flex">
							<div className="lg:w-1/2">
								...
								<p className="leading-9 xl:text-2xl xl:leading-10">
									...
									digital & VR content. The sole goal of the project is to
									empower digital creators, game developers, and VR tech
									enthusiasts with affordable solutions that can bring them
									authority over the web, while also fostering collaboration and
									creativity.
									<br />
									<br />
									The methodology of the project will be based over an open
									ecosystem, where the community is the head of the project.
									Support will be provided by the OVIRON core team with
									transparency delivery and constant integration of new
									technologies, solutions, and external partnership to help
									assure the evolution of the platform.
									<br />
									<br />
									The <strong>mission</strong> is solely to empower digital & VR
									content creators to gain ownership of their content, privacy
									of their spaces, and creative encouragement for indie
									projects. We
									<strong>vision</strong> a growth of unity and collaboration
									between indie creators all around the globe within an open
									virtual space, to lessen the distance gap.
									<br />
									<br />
					...
					<section>
						<div className="flex">
							<div className="text-center lg:w-1/2">
								...
								<p className="leading-9 xl:text-2xl xl:leading-10">
									Be part of growing community of creators and enthusiast to
									foster indie projects, and the virtual open space.
									<br />
									<br />
